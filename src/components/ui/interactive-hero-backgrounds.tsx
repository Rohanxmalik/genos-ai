...
// --- Standalone Ballpit canvas (background only, no UI chrome) ---
export const Ballpit: React.FC<BallpitCanvasProps> = ({ className, config: configOverride = {}, colors }) => {
    ...
    const config = useMemo(() => ({
        ...
        ...configOverride,
        colors: colors ?? (theme === "light" ? lightColors : darkColors),
    }), [configOverride, theme, colors]);
...
// --- Full hero (kept as the original 21st.dev component) ---
